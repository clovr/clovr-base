	function buildTree(compWinId) {
		
		var treeLoader = new Ext.tree.TreeLoader({ 
			dataUrl: '/clovr/clovr_comparative/cgi-bin/NcbiJsonSender.cgi'
		});
		...
		var myStore = new Ext.data.JsonStore({
			url : '/clovr/clovr_comparative/cgi-bin/SendGridJson.cgi',
			root : 'info',
		...
		var clovrMug = new Ext.Button({
			...
			handler : function() {
				...
				if(!nodeIds){
					...
					Ext.Ajax.request({
						url : '/clovr/clovr_comparative/cgi-bin/NcbiJsonSender.cgi',
						form : 'clovr_mug',
						params : {
							IDs : nodeIds,
		...
		var comboStore = new Ext.data.ArrayStore({
			url : '/clovr/clovr_comparative/cgi-bin/GetLineage.cgi',
			id : 0,
			fields : ['nodeName']
		});
		...
		var windowRef = Ext.getCmp(compWinId);

...
"\n"
"--db filename\n"
"    Reference database of chimera-free sequences in FASTA format.\n"
"    Optional, if not specified uchime uses de novo mode.\n"
"\n"
"\t***WARNING*** The database is searched ONLY on the plus strand.\n"
"\tYou MUST include both forward and reverse strand sequences in\n"
"\tthe database if you want both strands to be searched.\n"
"\n"
"--abskew x\n"
"    Minimum abundance skew. Default 1.9. De novo mode only.\n"
"    Tests suggest that much larger values seem to reduce the number\n"
"    of errors dramatically without much drop in sensitivity,\n"
"    better might be a value between 10 and 30. Abundance skew is:\n"
...
"--minlen L\n"
"--maxlen L\n"
"    Minimum and maximum query sequence length. Defaults 10, 10000.\n"
"\n"
"--ucl\n"

...
#define FLAG_OPT(LongName, ShortName, Help)							extern bool opt_##LongName; extern bool optset_##LongName;
#define TOG_OPT(LongName, ShortName, Default, Help)					extern bool opt_##LongName; extern bool optset_##LongName;
#define INT_OPT(LongName, ShortName, Default, Min, Max, Help)		extern int opt_##LongName; extern bool optset_##LongName;
#define UNS_OPT(LongName, ShortName, Default, Min, Max, Help)		extern unsigned opt_##LongName; extern bool optset_##LongName;
#define FLT_OPT(LongName, ShortName, Default, Min, Max, Help)		extern double opt_##LongName; extern bool optset_##LongName;
#define STR_OPT(LongName, ShortName, Default, Help)					extern string opt_##LongName; extern bool optset_##LongName;
#define ENUM_OPT(LongName, ShortName, Default, Values, Help)		extern int opt_##LongName; extern bool optset_##LongName;
#include "myopts.h"
#undef FLAG_OPT
#undef TOG_OPT
#undef INT_OPT

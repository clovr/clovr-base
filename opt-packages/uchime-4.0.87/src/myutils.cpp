...
static void DefineTogOpt(const string &LongName, const string &ShortName,
  bool Default, const string &Help, void *Value, bool *OptSet)
	{
	*(bool *) Value = Default;
...
static void DefineIntOpt(const string &LongName, const string &ShortName,
  int Default, int Min, int Max, const string &Help, void *Value, bool *OptSet)
	{
	*(int *) Value = Default;
...
static void DefineUnsOpt(const string &LongName, const string &ShortName,
  unsigned Default, unsigned Min, unsigned Max, const string &Help, void *Value, bool *OptSet)
	{
...
static void DefineFloatOpt(const string &LongName, const string &ShortName,
  double Default, double Min, double Max, const string &Help, void *Value, bool *OptSet)
	{
...
static void DefineStrOpt(const string &LongName, const string &ShortName,
  const char *Default, const string &Help, void *Value, bool *OptSet)
	{
...
#undef STR_OPT
#undef ENUM_OPT
#define FLAG_OPT(LongName, ShortName, Help)							bool opt_##LongName; bool optset_##LongName;
#define TOG_OPT(LongName, ShortName, Default, Help)					bool opt_##LongName; bool optset_##LongName;
#define INT_OPT(LongName, ShortName, Default, Min, Max, Help)		int opt_##LongName; bool optset_##LongName;
#define UNS_OPT(LongName, ShortName, Default, Min, Max, Help)		unsigned opt_##LongName; bool optset_##LongName;
#define FLT_OPT(LongName, ShortName, Default, Min, Max, Help)		double opt_##LongName; bool optset_##LongName;
#define STR_OPT(LongName, ShortName, Default, Help)					string opt_##LongName; bool optset_##LongName;
#define ENUM_OPT(LongName, ShortName, Values, Default, Help)		int opt_##LongName; bool optset_##LongName;
#include "myopts.h"
...
void MyCmdLine(int argc, char **argv)
	...
	DefineFlagOpt("quiet", "q", "Turn off progress messages.", (void *) &opt_quiet, &optset_compilerinfo);
	DefineFlagOpt("logopts", "-", "Log options.", (void *) &opt_logopts, &optset_compilerinfo);
	DefineFlagOpt("help", "-", "Display command-line options.", (void *) &opt_help, &optset_compilerinfo);
	DefineStrOpt("log", "-", "", "Log file name.", (void *) &opt_log, &optset_compilerinfo);
...
#undef STR_OPT
#undef ENUM_OPT
#define FLAG_OPT(LongName, ShortName, Help)							DefineFlagOpt(#LongName, #ShortName, Help, (void *) &opt_##LongName, &optset_##LongName);
#define TOG_OPT(LongName, ShortName, Default, Help)					DefineTogOpt(#LongName, #ShortName, Default, Help, (void *) &opt_##LongName, &optset_##LongName);
#define INT_OPT(LongName, ShortName, Default, Min, Max, Help)		DefineIntOpt(#LongName, #ShortName,  Default, Min, Max, Help, (void *) &opt_##LongName, &optset_##LongName);
#define UNS_OPT(LongName, ShortName, Default, Min, Max, Help)		DefineUnsOpt(#LongName, #ShortName, Default, Min, Max, Help, (void *) &opt_##LongName, &optset_##LongName);
#define FLT_OPT(LongName, ShortName, Default, Min, Max, Help)		DefineFloatOpt(#LongName, #ShortName, Default, Min, Max, Help, (void *) &opt_##LongName, &optset_##LongName);
#define STR_OPT(LongName, ShortName, Default, Help)					DefineStrOpt(#LongName, #ShortName, Default, Help, (void *) &opt_##LongName, &optset_##LongName);
#define ENUM_OPT(LongName, ShortName, Values, Default, Help)		DefineEnumOpt(#LongName, #ShortName, Values, Default, Help, (void *) &opt_##LongName, &optset_##LongName);
#include "myopts.h"

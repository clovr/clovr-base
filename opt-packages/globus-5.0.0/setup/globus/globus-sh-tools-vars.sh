...
#
GLOBUS_SH_QDEL="/opt/sge/bin/lx24-amd64/qdel"
GLOBUS_SH_QSTAT="/opt/sge/bin/lx24-amd64/qstat"
GLOBUS_SH_QSUB="/opt/sge/bin/lx24-amd64/qsub"

# these are only used for GRD
GLOBUS_SH_QSELECT="/opt/sge/bin/lx24-amd64/qselect"
GLOBUS_SH_QHOST="/opt/sge/bin/lx24-amd64/qhost"
GLOBUS_SH_QCONF="/opt/sge/bin/lx24-amd64/qconf"

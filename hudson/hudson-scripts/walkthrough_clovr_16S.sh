...
vp-add-dataset -o --tag-name=clovr_16S_multi_input_$2 /opt/hudson/walkthrough_datasets/clovr_16S/fastas/*.fasta
vp-add-dataset -o --tag-name=clovr_16S_multi_mapping /opt/hudson/walkthrough_datasets/clovr_16S/HumanizedMice.map
